...
def test_both_families_are_rewritten() -> None:
    ...
    # Which family a row is for is the address it holds, not a colon found in
    # a string, and it is what the declaration names the resource by.
    assert [entry.family for entry in entries] == ['v4', 'v6']
