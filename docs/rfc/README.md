...
| [rfc-004](rfc-004-rfc-process.md) | The RFC process: when one is required, what it contains, its lifecycle and review gate, amendment, numbering. | Accepted | The mechanism is [framework/rfc.md](../framework/rfc.md); rfc-004 §11 names where the rest lands. |
