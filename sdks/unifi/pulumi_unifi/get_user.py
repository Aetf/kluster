...
class GetUserResult:
    ...
    def __init__(__self__, blocked=None, dev_id_override=None, fixed_ip=None, hostname=None, id=None, ip=None, local_dns_record=None, mac=None, name=None, network_id=None, note=None, site=None, user_group_id=None):
        ...
        if dev_id_override and not isinstance(dev_id_override, float):
            raise TypeError("Expected argument 'dev_id_override' to be a float")
    ...
    def dev_id_override(self) -> _builtins.float:
...
def get_user(mac: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult, package_ref=_utilities.get_package()).value
...
def get_user_output(mac: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult, package_ref=_utilities.get_package())
