...
def get_radius_profile(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi:index/getRadiusProfile:getRadiusProfile', __args__, opts=opts, typ=GetRadiusProfileResult, package_ref=_utilities.get_package()).value
...
def get_radius_profile_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi:index/getRadiusProfile:getRadiusProfile', __args__, opts=opts, typ=GetRadiusProfileResult, package_ref=_utilities.get_package())
