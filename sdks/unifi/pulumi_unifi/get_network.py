...
class GetNetworkResult:
    ...
    def __init__(__self__, dhcp_dns=None, dhcp_enabled=None, dhcp_guarding=None, dhcp_lease=None, dhcp_start=None, dhcp_stop=None, dhcp_v6_dns=None, dhcp_v6_dns_auto=None, dhcp_v6_enabled=None, dhcp_v6_lease=None, dhcp_v6_start=None, dhcp_v6_stop=None, dhcpd_boot_enabled=None, dhcpd_boot_filename=None, dhcpd_boot_server=None, dhcpd_gateway=None, dhcpd_gateway_enabled=None, domain_name=None, firewall_zone_id=None, id=None, igmp_snooping=None, ipv6_interface_type=None, ipv6_pd_interface=None, ipv6_pd_prefixid=None, ipv6_pd_start=None, ipv6_pd_stop=None, ipv6_ra_enable=None, ipv6_ra_preferred_lifetime=None, ipv6_ra_priority=None, ipv6_ra_valid_lifetime=None, ipv6_static_subnet=None, multicast_dns=None, name=None, network_group=None, purpose=None, site=None, subnet=None, vlan_id=None, wan_dhcp_v6_pd_size=None, wan_dns=None, wan_egress_qos=None, wan_gateway=None, wan_gateway_v6=None, wan_ip=None, wan_ipv6=None, wan_netmask=None, wan_networkgroup=None, wan_prefixlen=None, wan_type=None, wan_type_v6=None, wan_username=None, x_wan_password=None):
        ...
        if dhcp_lease and not isinstance(dhcp_lease, float):
            raise TypeError("Expected argument 'dhcp_lease' to be a float")
        ...
        if dhcp_v6_lease and not isinstance(dhcp_v6_lease, float):
            raise TypeError("Expected argument 'dhcp_v6_lease' to be a float")
        ...
        if ipv6_ra_preferred_lifetime and not isinstance(ipv6_ra_preferred_lifetime, float):
            raise TypeError("Expected argument 'ipv6_ra_preferred_lifetime' to be a float")
        ...
        if ipv6_ra_valid_lifetime and not isinstance(ipv6_ra_valid_lifetime, float):
            raise TypeError("Expected argument 'ipv6_ra_valid_lifetime' to be a float")
        ...
        if wan_dhcp_v6_pd_size and not isinstance(wan_dhcp_v6_pd_size, float):
            raise TypeError("Expected argument 'wan_dhcp_v6_pd_size' to be a float")
        ...
        if wan_egress_qos and not isinstance(wan_egress_qos, float):
            raise TypeError("Expected argument 'wan_egress_qos' to be a float")
        ...
        if wan_prefixlen and not isinstance(wan_prefixlen, float):
            raise TypeError("Expected argument 'wan_prefixlen' to be a float")
    ...
    def dhcp_lease(self) -> _builtins.float:
    ...
    def dhcp_v6_lease(self) -> _builtins.float:
    ...
    def ipv6_ra_preferred_lifetime(self) -> _builtins.float:
    ...
    def ipv6_ra_valid_lifetime(self) -> _builtins.float:
    ...
    def wan_dhcp_v6_pd_size(self) -> _builtins.float:
    ...
    def wan_egress_qos(self) -> _builtins.float:
    ...
    def wan_prefixlen(self) -> _builtins.float:
...
def get_network(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi:index/getNetwork:getNetwork', __args__, opts=opts, typ=GetNetworkResult, package_ref=_utilities.get_package()).value
...
def get_network_output(id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi:index/getNetwork:getNetwork', __args__, opts=opts, typ=GetNetworkResult, package_ref=_utilities.get_package())
