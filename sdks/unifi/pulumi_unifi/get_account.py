...
class GetAccountResult:
    ...
    def __init__(__self__, id=None, name=None, network_id=None, password=None, site=None, tunnel_medium_type=None, tunnel_type=None, vlan=None):
        ...
        if tunnel_medium_type and not isinstance(tunnel_medium_type, float):
            raise TypeError("Expected argument 'tunnel_medium_type' to be a float")
        pulumi.set(__self__, "tunnel_medium_type", tunnel_medium_type)
        if tunnel_type and not isinstance(tunnel_type, float):
            raise TypeError("Expected argument 'tunnel_type' to be a float")
    ...
    def tunnel_medium_type(self) -> _builtins.float:
        return pulumi.get(self, "tunnel_medium_type")

    @_builtins.property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> _builtins.float:
...
def get_account(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi:index/getAccount:getAccount', __args__, opts=opts, typ=GetAccountResult, package_ref=_utilities.get_package()).value
...
def get_account_output(name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi:index/getAccount:getAccount', __args__, opts=opts, typ=GetAccountResult, package_ref=_utilities.get_package())
