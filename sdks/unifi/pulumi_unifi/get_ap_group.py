...
def get_ap_group(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi:index/getApGroup:getApGroup', __args__, opts=opts, typ=GetApGroupResult, package_ref=_utilities.get_package()).value
...
def get_ap_group_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi:index/getApGroup:getApGroup', __args__, opts=opts, typ=GetApGroupResult, package_ref=_utilities.get_package())
