...
class DeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] forget_on_destroy: Whether to forget (un-adopt) the device when this resource is destroyed. When true:
               ...
               * Device configuration will be reset
                 Set to false to keep the device adopted when removing from Terraform management. Defaults to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`" pulumi-lang-hcl="`true`">`true`</span>.
        ...
        :param pulumi.Input[_builtins.bool] switch_vlan_enabled: Whether per-port VLAN configuration is enabled on the device. Required for <span pulumi-lang-nodejs="`portOverride`" pulumi-lang-dotnet="`PortOverride`" pulumi-lang-go="`portOverride`" pulumi-lang-python="`port_override`" pulumi-lang-yaml="`portOverride`" pulumi-lang-java="`portOverride`" pulumi-lang-hcl="`port_override`">`portOverride`</span> blocks with VLAN-tagging profiles (e.g. an IoT-VLAN <span pulumi-lang-nodejs="`portProfileId`" pulumi-lang-dotnet="`PortProfileId`" pulumi-lang-go="`portProfileId`" pulumi-lang-python="`port_profile_id`" pulumi-lang-yaml="`portProfileId`" pulumi-lang-java="`portProfileId`" pulumi-lang-hcl="`port_profile_id`">`portProfileId`</span>) to actually take effect on access points that expose passthrough Ethernet ports (UAP-UHDIW and similar in-wall units). Switches honor port profile VLAN bindings unconditionally; APs ignore them unless this flag is true. Note: the underlying field uses <span pulumi-lang-nodejs="`omitempty`" pulumi-lang-dotnet="`Omitempty`" pulumi-lang-go="`omitempty`" pulumi-lang-python="`omitempty`" pulumi-lang-yaml="`omitempty`" pulumi-lang-java="`omitempty`" pulumi-lang-hcl="`omitempty`">`omitempty`</span> so setting this to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span> has no effect — once enabled on a device, it can only be disabled via the UI.
        """
    ...
    def radios(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DeviceRadioArgs']]]]:
        """
        Per-band radio configuration for access points. Each block configures ONE band (<span pulumi-lang-nodejs="`ng`" pulumi-lang-dotnet="`Ng`" pulumi-lang-go="`ng`" pulumi-lang-python="`ng`" pulumi-lang-yaml="`ng`" pulumi-lang-java="`ng`" pulumi-lang-hcl="`ng`">`ng`</span> = 2.4GHz, <span pulumi-lang-nodejs="`na`" pulumi-lang-dotnet="`Na`" pulumi-lang-go="`na`" pulumi-lang-python="`na`" pulumi-lang-yaml="`na`" pulumi-lang-java="`na`" pulumi-lang-hcl="`na`">`na`</span> = 5GHz, <span pulumi-lang-nodejs="`6e`" pulumi-lang-dotnet="`6e`" pulumi-lang-go="`6e`" pulumi-lang-python="`6e`" pulumi-lang-yaml="`6e`" pulumi-lang-java="`6e`" pulumi-lang-hcl="`6e`">`6e`</span> = 6GHz). Only the bands you declare are managed — undeclared bands are left untouched (the provider read-modify-writes the device's full radio table to preserve them, so declaring just one band will not wipe the others). Common uses: disable a band (<span pulumi-lang-nodejs="`txPowerMode " pulumi-lang-dotnet="`TxPowerMode " pulumi-lang-go="`txPowerMode " pulumi-lang-python="`tx_power_mode " pulumi-lang-yaml="`txPowerMode " pulumi-lang-java="`txPowerMode " pulumi-lang-hcl="`tx_power_mode ">`txPowerMode </span>= "disabled"`), pin a channel/width, or set a minimum-RSSI client kick. Applies to access points; has no effect on switches.
    ...
    def switch_vlan_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether per-port VLAN configuration is enabled on the device. Required for <span pulumi-lang-nodejs="`portOverride`" pulumi-lang-dotnet="`PortOverride`" pulumi-lang-go="`portOverride`" pulumi-lang-python="`port_override`" pulumi-lang-yaml="`portOverride`" pulumi-lang-java="`portOverride`" pulumi-lang-hcl="`port_override`">`portOverride`</span> blocks with VLAN-tagging profiles (e.g. an IoT-VLAN <span pulumi-lang-nodejs="`portProfileId`" pulumi-lang-dotnet="`PortProfileId`" pulumi-lang-go="`portProfileId`" pulumi-lang-python="`port_profile_id`" pulumi-lang-yaml="`portProfileId`" pulumi-lang-java="`portProfileId`" pulumi-lang-hcl="`port_profile_id`">`portProfileId`</span>) to actually take effect on access points that expose passthrough Ethernet ports (UAP-UHDIW and similar in-wall units). Switches honor port profile VLAN bindings unconditionally; APs ignore them unless this flag is true. Note: the underlying field uses <span pulumi-lang-nodejs="`omitempty`" pulumi-lang-dotnet="`Omitempty`" pulumi-lang-go="`omitempty`" pulumi-lang-python="`omitempty`" pulumi-lang-yaml="`omitempty`" pulumi-lang-java="`omitempty`" pulumi-lang-hcl="`omitempty`">`omitempty`</span> so setting this to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span> has no effect — once enabled on a device, it can only be disabled via the UI.
        """
