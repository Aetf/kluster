...
@pulumi.input_type
class _SettingCountryState:
    def __init__(__self__, *,
                 code: pulumi.Input[Optional[_builtins.str]] = None,
                 code_numeric: pulumi.Input[Optional[_builtins.float]] = None,
                 site: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering SettingCountry resources.

        :param pulumi.Input[_builtins.str] code: The country code to set for the UniFi site. The country code must be a valid ISO 3166-1 alpha-2 code.
        :param pulumi.Input[_builtins.float] code_numeric: The numeric representation in ISO 3166-1 of the country code.
        :param pulumi.Input[_builtins.str] site: The name of the UniFi site where this resource should be applied. If not specified, the default site will be used.
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
    ...
    def code_numeric(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    @code_numeric.setter
    def code_numeric(self, value: pulumi.Input[Optional[_builtins.float]]):
...
@pulumi.type_token("unifi:index/settingCountry:SettingCountry")
class SettingCountry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SettingCountry, __self__).__init__(
            'unifi:index/settingCountry:SettingCountry',
            resource_name,
            __props__,
            opts,
    ...
    def get(resource_name: str,
            ...
            code: pulumi.Input[Optional[_builtins.str]] = None,
            code_numeric: pulumi.Input[Optional[_builtins.float]] = None,
            site: pulumi.Input[Optional[_builtins.str]] = None) -> 'SettingCountry':
        """
        ...
        __props__ = _SettingCountryState.__new__(_SettingCountryState)
    ...
    @_builtins.property
    @pulumi.getter(name="codeNumeric")
    def code_numeric(self) -> pulumi.Output[_builtins.float]:
        """
        The numeric representation in ISO 3166-1 of the country code.
        """
        return pulumi.get(self, "code_numeric")
