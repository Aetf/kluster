...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 http_max_retries: pulumi.Input[Optional[_builtins.float]] = None,
    ...
    def http_max_retries(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def http_max_retries(self, value: pulumi.Input[Optional[_builtins.float]]):
...
class Provider(pulumi.ProviderResource):
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:unifi/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult, package_ref=_utilities.get_package())
