...
class PortProfileArgs:
    def __init__(__self__, *,
                 ...
                 dot1x_idle_timeout: pulumi.Input[Optional[_builtins.float]] = None,
                 egress_rate_limit_kbps: pulumi.Input[Optional[_builtins.float]] = None,
                 ...
                 priority_queue1_level: pulumi.Input[Optional[_builtins.float]] = None,
                 priority_queue2_level: pulumi.Input[Optional[_builtins.float]] = None,
                 priority_queue3_level: pulumi.Input[Optional[_builtins.float]] = None,
                 priority_queue4_level: pulumi.Input[Optional[_builtins.float]] = None,
                 site: pulumi.Input[Optional[_builtins.str]] = None,
                 speed: pulumi.Input[Optional[_builtins.float]] = None,
                 stormctrl_bcast_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 stormctrl_bcast_level: pulumi.Input[Optional[_builtins.float]] = None,
                 stormctrl_bcast_rate: pulumi.Input[Optional[_builtins.float]] = None,
                 stormctrl_mcast_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 stormctrl_mcast_level: pulumi.Input[Optional[_builtins.float]] = None,
                 stormctrl_mcast_rate: pulumi.Input[Optional[_builtins.float]] = None,
                 stormctrl_type: pulumi.Input[Optional[_builtins.str]] = None,
                 stormctrl_ucast_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 stormctrl_ucast_level: pulumi.Input[Optional[_builtins.float]] = None,
                 stormctrl_ucast_rate: pulumi.Input[Optional[_builtins.float]] = None,
        ...
        :param pulumi.Input[_builtins.bool] autoneg: Enable automatic negotiation of port speed and duplex settings. When enabled, this overrides manual speed and duplex settings. Recommended for most use cases. Defaults to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`" pulumi-lang-hcl="`true`">`true`</span>.
        :param pulumi.Input[_builtins.str] dot1x_ctrl: 802.1X port-based network access control (PNAC) mode. Valid values are:
                 * <span pulumi-lang-nodejs="`forceAuthorized`" pulumi-lang-dotnet="`ForceAuthorized`" pulumi-lang-go="`forceAuthorized`" pulumi-lang-python="`force_authorized`" pulumi-lang-yaml="`forceAuthorized`" pulumi-lang-java="`forceAuthorized`" pulumi-lang-hcl="`force_authorized`">`forceAuthorized`</span> - Port allows all traffic, no authentication required (default)
                 * <span pulumi-lang-nodejs="`forceUnauthorized`" pulumi-lang-dotnet="`ForceUnauthorized`" pulumi-lang-go="`forceUnauthorized`" pulumi-lang-python="`force_unauthorized`" pulumi-lang-yaml="`forceUnauthorized`" pulumi-lang-java="`forceUnauthorized`" pulumi-lang-hcl="`force_unauthorized`">`forceUnauthorized`</span> - Port blocks all traffic regardless of authentication
                 * <span pulumi-lang-nodejs="`auto`" pulumi-lang-dotnet="`Auto`" pulumi-lang-go="`auto`" pulumi-lang-python="`auto`" pulumi-lang-yaml="`auto`" pulumi-lang-java="`auto`" pulumi-lang-hcl="`auto`">`auto`</span> - Standard 802.1X authentication required before port access is granted
                 * <span pulumi-lang-nodejs="`macBased`" pulumi-lang-dotnet="`MacBased`" pulumi-lang-go="`macBased`" pulumi-lang-python="`mac_based`" pulumi-lang-yaml="`macBased`" pulumi-lang-java="`macBased`" pulumi-lang-hcl="`mac_based`">`macBased`</span> - Authentication based on client MAC address, useful for devices that don't support 802.1X
                 * <span pulumi-lang-nodejs="`multiHost`" pulumi-lang-dotnet="`MultiHost`" pulumi-lang-go="`multiHost`" pulumi-lang-python="`multi_host`" pulumi-lang-yaml="`multiHost`" pulumi-lang-java="`multiHost`" pulumi-lang-hcl="`multi_host`">`multiHost`</span> - Allows multiple devices after first successful authentication, common in VoIP phone setups
               
               Use 'auto' for highest security, 'mac_based' for legacy devices, and 'multi_host' when daisy-chaining devices. Defaults to <span pulumi-lang-nodejs="`forceAuthorized`" pulumi-lang-dotnet="`ForceAuthorized`" pulumi-lang-go="`forceAuthorized`" pulumi-lang-python="`force_authorized`" pulumi-lang-yaml="`forceAuthorized`" pulumi-lang-java="`forceAuthorized`" pulumi-lang-hcl="`force_authorized`">`forceAuthorized`</span>.
        :param pulumi.Input[_builtins.float] dot1x_idle_timeout: The number of seconds before an inactive authenticated MAC address is removed when using MAC-based 802.1X control. Range: 0-65535 seconds. Defaults to <span pulumi-lang-nodejs="`300`" pulumi-lang-dotnet="`300`" pulumi-lang-go="`300`" pulumi-lang-python="`300`" pulumi-lang-yaml="`300`" pulumi-lang-java="`300`" pulumi-lang-hcl="`300`">`300`</span>.
        :param pulumi.Input[_builtins.float] egress_rate_limit_kbps: The maximum outbound bandwidth allowed on the port in kilobits per second. Range: 64-9999999 kbps. Only applied when<span pulumi-lang-nodejs=" egressRateLimitKbpsEnabled " pulumi-lang-dotnet=" EgressRateLimitKbpsEnabled " pulumi-lang-go=" egressRateLimitKbpsEnabled " pulumi-lang-python=" egress_rate_limit_kbps_enabled " pulumi-lang-yaml=" egressRateLimitKbpsEnabled " pulumi-lang-java=" egressRateLimitKbpsEnabled " pulumi-lang-hcl=" egress_rate_limit_kbps_enabled "> egressRateLimitKbpsEnabled </span>is true.
        :param pulumi.Input[_builtins.bool] egress_rate_limit_kbps_enabled: Enable outbound bandwidth rate limiting on the port. When enabled, traffic will be limited to the rate specified in egress_rate_limit_kbps. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        ...
        :param pulumi.Input[_builtins.str] forward: VLAN forwarding mode for the port. Valid values are:
               ...
               > **Note:** For an access port configured only with <span pulumi-lang-nodejs="`nativeNetworkconfId`" pulumi-lang-dotnet="`NativeNetworkconfId`" pulumi-lang-go="`nativeNetworkconfId`" pulumi-lang-python="`native_networkconf_id`" pulumi-lang-yaml="`nativeNetworkconfId`" pulumi-lang-java="`nativeNetworkconfId`" pulumi-lang-hcl="`native_networkconf_id`">`nativeNetworkconfId`</span> the controller normalizes the stored mode to <span pulumi-lang-nodejs="`customize`" pulumi-lang-dotnet="`Customize`" pulumi-lang-go="`customize`" pulumi-lang-python="`customize`" pulumi-lang-yaml="`customize`" pulumi-lang-java="`customize`" pulumi-lang-hcl="`customize`">`customize`</span>. With the default value of <span pulumi-lang-nodejs="`native`" pulumi-lang-dotnet="`Native`" pulumi-lang-go="`native`" pulumi-lang-python="`native`" pulumi-lang-yaml="`native`" pulumi-lang-java="`native`" pulumi-lang-hcl="`native`">`native`</span> this currently results in a non-failing perpetual diff (`~ forward = "customize" > "native"`) on every plan. To avoid it, set `forward = "customize"` explicitly. See issue #98. Defaults to <span pulumi-lang-nodejs="`native`" pulumi-lang-dotnet="`Native`" pulumi-lang-go="`native`" pulumi-lang-python="`native`" pulumi-lang-yaml="`native`" pulumi-lang-java="`native`" pulumi-lang-hcl="`native`">`native`</span>.
        :param pulumi.Input[_builtins.bool] full_duplex: Enable full-duplex mode when auto-negotiation is disabled. Full duplex allows simultaneous two-way communication. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        :param pulumi.Input[_builtins.bool] isolation: Enable port isolation. When enabled, devices connected to ports with this profile cannot communicate with each other, providing enhanced security. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        :param pulumi.Input[_builtins.bool] lldpmed_enabled: Enable Link Layer Discovery Protocol-Media Endpoint Discovery (LLDP-MED). This allows for automatic discovery and configuration of devices like VoIP phones. Defaults to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`" pulumi-lang-hcl="`true`">`true`</span>.
        ...
        :param pulumi.Input[_builtins.str] op_mode: The operation mode for the port profile. Can only be <span pulumi-lang-nodejs="`switch`" pulumi-lang-dotnet="`Switch`" pulumi-lang-go="`switch`" pulumi-lang-python="`switch`" pulumi-lang-yaml="`switch`" pulumi-lang-java="`switch`" pulumi-lang-hcl="`switch`">`switch`</span> Defaults to <span pulumi-lang-nodejs="`switch`" pulumi-lang-dotnet="`Switch`" pulumi-lang-go="`switch`" pulumi-lang-python="`switch`" pulumi-lang-yaml="`switch`" pulumi-lang-java="`switch`" pulumi-lang-hcl="`switch`">`switch`</span>.
        :param pulumi.Input[_builtins.str] poe_mode: The POE mode for the port profile. Can be one of <span pulumi-lang-nodejs="`auto`" pulumi-lang-dotnet="`Auto`" pulumi-lang-go="`auto`" pulumi-lang-python="`auto`" pulumi-lang-yaml="`auto`" pulumi-lang-java="`auto`" pulumi-lang-hcl="`auto`">`auto`</span>, <span pulumi-lang-nodejs="`passv24`" pulumi-lang-dotnet="`Passv24`" pulumi-lang-go="`passv24`" pulumi-lang-python="`passv24`" pulumi-lang-yaml="`passv24`" pulumi-lang-java="`passv24`" pulumi-lang-hcl="`passv24`">`passv24`</span>, <span pulumi-lang-nodejs="`passthrough`" pulumi-lang-dotnet="`Passthrough`" pulumi-lang-go="`passthrough`" pulumi-lang-python="`passthrough`" pulumi-lang-yaml="`passthrough`" pulumi-lang-java="`passthrough`" pulumi-lang-hcl="`passthrough`">`passthrough`</span> or <span pulumi-lang-nodejs="`off`" pulumi-lang-dotnet="`Off`" pulumi-lang-go="`off`" pulumi-lang-python="`off`" pulumi-lang-yaml="`off`" pulumi-lang-java="`off`" pulumi-lang-hcl="`off`">`off`</span>.
        :param pulumi.Input[_builtins.bool] port_security_enabled: Enable MAC address-based port security. When enabled:
               ...
               * Must be used with<span pulumi-lang-nodejs=" portSecurityMacAddress " pulumi-lang-dotnet=" PortSecurityMacAddress " pulumi-lang-go=" portSecurityMacAddress " pulumi-lang-python=" port_security_mac_address " pulumi-lang-yaml=" portSecurityMacAddress " pulumi-lang-java=" portSecurityMacAddress " pulumi-lang-hcl=" port_security_mac_address "> portSecurityMacAddress </span>list Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] port_security_mac_addresses: List of allowed MAC addresses when port security is enabled. Each address should be:
               ...
               * Verified to belong to authorized devices
                 Only effective when<span pulumi-lang-nodejs=" portSecurityEnabled " pulumi-lang-dotnet=" PortSecurityEnabled " pulumi-lang-go=" portSecurityEnabled " pulumi-lang-python=" port_security_enabled " pulumi-lang-yaml=" portSecurityEnabled " pulumi-lang-java=" portSecurityEnabled " pulumi-lang-hcl=" port_security_enabled "> portSecurityEnabled </span>is true
        :param pulumi.Input[_builtins.float] priority_queue1_level: Priority queue 1 level (0-100) for Quality of Service (QoS). Used for:
               * Low-priority background traffic
               * Bulk data transfers
               * Non-time-sensitive applications
                 Higher values give more bandwidth to this queue
        :param pulumi.Input[_builtins.float] priority_queue2_level: Priority queue 2 level (0-100) for Quality of Service (QoS). Used for:
               * Standard user traffic
               * Web browsing and email
               * General business applications
                 Higher values give more bandwidth to this queue
        :param pulumi.Input[_builtins.float] priority_queue3_level: Priority queue 3 level (0-100) for Quality of Service (QoS). Used for:
               * High-priority traffic
               * Voice and video conferencing
               * Time-sensitive applications
                 Higher values give more bandwidth to this queue
        :param pulumi.Input[_builtins.float] priority_queue4_level: Priority queue 4 level (0-100) for Quality of Service (QoS). Used for:
        ...
        :param pulumi.Input[_builtins.float] speed: Port speed in Mbps when auto-negotiation is disabled. Common values:
        ...
        :param pulumi.Input[_builtins.bool] stormctrl_bcast_enabled: Enable broadcast storm control. When enabled:
               ...
               * Helps maintain network stability
                 Use with<span pulumi-lang-nodejs=" stormctrlBcastRate " pulumi-lang-dotnet=" StormctrlBcastRate " pulumi-lang-go=" stormctrlBcastRate " pulumi-lang-python=" stormctrl_bcast_rate " pulumi-lang-yaml=" stormctrlBcastRate " pulumi-lang-java=" stormctrlBcastRate " pulumi-lang-hcl=" stormctrl_bcast_rate "> stormctrlBcastRate </span>to set threshold Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        :param pulumi.Input[_builtins.float] stormctrl_bcast_level: The broadcast Storm Control level for the port profile. Can be between 0 and 100.
        :param pulumi.Input[_builtins.float] stormctrl_bcast_rate: Maximum broadcast traffic rate in packets per second (0 - 14880000). Used to:
               * Control broadcast traffic levels
               * Prevent network congestion
               * Balance between necessary broadcasts and network protection
                 Only effective when <span pulumi-lang-nodejs="`stormctrlBcastEnabled`" pulumi-lang-dotnet="`StormctrlBcastEnabled`" pulumi-lang-go="`stormctrlBcastEnabled`" pulumi-lang-python="`stormctrl_bcast_enabled`" pulumi-lang-yaml="`stormctrlBcastEnabled`" pulumi-lang-java="`stormctrlBcastEnabled`" pulumi-lang-hcl="`stormctrl_bcast_enabled`">`stormctrlBcastEnabled`</span> is true
        :param pulumi.Input[_builtins.bool] stormctrl_mcast_enabled: Enable multicast storm control. When enabled:
               ...
               * Helps maintain quality of service
                 Use with <span pulumi-lang-nodejs="`stormctrlMcastRate`" pulumi-lang-dotnet="`StormctrlMcastRate`" pulumi-lang-go="`stormctrlMcastRate`" pulumi-lang-python="`stormctrl_mcast_rate`" pulumi-lang-yaml="`stormctrlMcastRate`" pulumi-lang-java="`stormctrlMcastRate`" pulumi-lang-hcl="`stormctrl_mcast_rate`">`stormctrlMcastRate`</span> to set threshold Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        :param pulumi.Input[_builtins.float] stormctrl_mcast_level: The multicast Storm Control level for the port profile. Can be between 0 and 100.
        :param pulumi.Input[_builtins.float] stormctrl_mcast_rate: Maximum multicast traffic rate in packets per second (0 - 14880000). Used to:
               ...
               * Prevent multicast traffic from overwhelming the network
                 Only effective when<span pulumi-lang-nodejs=" stormctrlMcastEnabled " pulumi-lang-dotnet=" StormctrlMcastEnabled " pulumi-lang-go=" stormctrlMcastEnabled " pulumi-lang-python=" stormctrl_mcast_enabled " pulumi-lang-yaml=" stormctrlMcastEnabled " pulumi-lang-java=" stormctrlMcastEnabled " pulumi-lang-hcl=" stormctrl_mcast_enabled "> stormctrlMcastEnabled </span>is true
        :param pulumi.Input[_builtins.str] stormctrl_type: The type of Storm Control to use for the port profile. Can be one of <span pulumi-lang-nodejs="`level`" pulumi-lang-dotnet="`Level`" pulumi-lang-go="`level`" pulumi-lang-python="`level`" pulumi-lang-yaml="`level`" pulumi-lang-java="`level`" pulumi-lang-hcl="`level`">`level`</span> or <span pulumi-lang-nodejs="`rate`" pulumi-lang-dotnet="`Rate`" pulumi-lang-go="`rate`" pulumi-lang-python="`rate`" pulumi-lang-yaml="`rate`" pulumi-lang-java="`rate`" pulumi-lang-hcl="`rate`">`rate`</span>.
        :param pulumi.Input[_builtins.bool] stormctrl_ucast_enabled: Enable unknown unicast storm control. When enabled:
               ...
               * Helps maintain network performance
                 Use with<span pulumi-lang-nodejs=" stormctrlUcastRate " pulumi-lang-dotnet=" StormctrlUcastRate " pulumi-lang-go=" stormctrlUcastRate " pulumi-lang-python=" stormctrl_ucast_rate " pulumi-lang-yaml=" stormctrlUcastRate " pulumi-lang-java=" stormctrlUcastRate " pulumi-lang-hcl=" stormctrl_ucast_rate "> stormctrlUcastRate </span>to set threshold Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        :param pulumi.Input[_builtins.float] stormctrl_ucast_level: The unknown unicast Storm Control level for the port profile. Can be between 0 and 100.
        :param pulumi.Input[_builtins.float] stormctrl_ucast_rate: Maximum unknown unicast traffic rate in packets per second (0 - 14880000). Used to:
               ...
               * Balance security with network usability
                 Only effective when<span pulumi-lang-nodejs=" stormctrlUcastEnabled " pulumi-lang-dotnet=" StormctrlUcastEnabled " pulumi-lang-go=" stormctrlUcastEnabled " pulumi-lang-python=" stormctrl_ucast_enabled " pulumi-lang-yaml=" stormctrlUcastEnabled " pulumi-lang-java=" stormctrlUcastEnabled " pulumi-lang-hcl=" stormctrl_ucast_enabled "> stormctrlUcastEnabled </span>is true
        :param pulumi.Input[_builtins.bool] stp_port_mode: Spanning Tree Protocol (STP) configuration for the port. When enabled:
               ...
               * Can be disabled on end-device ports for faster initialization Defaults to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`" pulumi-lang-hcl="`true`">`true`</span>.
        :param pulumi.Input[_builtins.str] tagged_vlan_mgmt: VLAN tagging behavior for the port. Valid values are:
               ...
               * <span pulumi-lang-nodejs="`custom`" pulumi-lang-dotnet="`Custom`" pulumi-lang-go="`custom`" pulumi-lang-python="`custom`" pulumi-lang-yaml="`custom`" pulumi-lang-java="`custom`" pulumi-lang-hcl="`custom`">`custom`</span> - Custom VLAN configuration
    ...
    def autoneg(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enable automatic negotiation of port speed and duplex settings. When enabled, this overrides manual speed and duplex settings. Recommended for most use cases. Defaults to <span pulumi-lang-nodejs="`true`" pulumi-lang-dotnet="`True`" pulumi-lang-go="`true`" pulumi-lang-python="`true`" pulumi-lang-yaml="`true`" pulumi-lang-java="`true`" pulumi-lang-hcl="`true`">`true`</span>.
        """
    ...
    def dot1x_idle_timeout(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def dot1x_idle_timeout(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "dot1x_idle_timeout", value)

    @_builtins.property
    @pulumi.getter(name="egressRateLimitKbps")
    def egress_rate_limit_kbps(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        The maximum outbound bandwidth allowed on the port in kilobits per second. Range: 64-9999999 kbps. Only applied when<span pulumi-lang-nodejs=" egressRateLimitKbpsEnabled " pulumi-lang-dotnet=" EgressRateLimitKbpsEnabled " pulumi-lang-go=" egressRateLimitKbpsEnabled " pulumi-lang-python=" egress_rate_limit_kbps_enabled " pulumi-lang-yaml=" egressRateLimitKbpsEnabled " pulumi-lang-java=" egressRateLimitKbpsEnabled " pulumi-lang-hcl=" egress_rate_limit_kbps_enabled "> egressRateLimitKbpsEnabled </span>is true.
        """
        return pulumi.get(self, "egress_rate_limit_kbps")

    @egress_rate_limit_kbps.setter
    def egress_rate_limit_kbps(self, value: pulumi.Input[Optional[_builtins.float]]):
    ...
    def egress_rate_limit_kbps_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enable outbound bandwidth rate limiting on the port. When enabled, traffic will be limited to the rate specified in egress_rate_limit_kbps. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        """
    ...
    def isolation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enable port isolation. When enabled, devices connected to ports with this profile cannot communicate with each other, providing enhanced security. Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`" pulumi-lang-hcl="`false`">`false`</span>.
        """
    ...
    def op_mode(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The operation mode for the port profile. Can only be <span pulumi-lang-nodejs="`switch`" pulumi-lang-dotnet="`Switch`" pulumi-lang-go="`switch`" pulumi-lang-python="`switch`" pulumi-lang-yaml="`switch`" pulumi-lang-java="`switch`" pulumi-lang-hcl="`switch`">`switch`</span> Defaults to <span pulumi-lang-nodejs="`switch`" pulumi-lang-dotnet="`Switch`" pulumi-lang-go="`switch`" pulumi-lang-python="`switch`" pulumi-lang-yaml="`switch`" pulumi-lang-java="`switch`" pulumi-lang-hcl="`switch`">`switch`</span>.
        """
    ...
    def priority_queue1_level(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def priority_queue1_level(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "priority_queue1_level", value)

    @_builtins.property
    @pulumi.getter(name="priorityQueue2Level")
    def priority_queue2_level(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def priority_queue2_level(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "priority_queue2_level", value)

    @_builtins.property
    @pulumi.getter(name="priorityQueue3Level")
    def priority_queue3_level(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def priority_queue3_level(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "priority_queue3_level", value)

    @_builtins.property
    @pulumi.getter(name="priorityQueue4Level")
    def priority_queue4_level(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def priority_queue4_level(self, value: pulumi.Input[Optional[_builtins.float]]):
    ...
    @_builtins.property
    @pulumi.getter
    def speed(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    @speed.setter
    def speed(self, value: pulumi.Input[Optional[_builtins.float]]):
    ...
    def stormctrl_bcast_level(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def stormctrl_bcast_level(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "stormctrl_bcast_level", value)

    @_builtins.property
    @pulumi.getter(name="stormctrlBcastRate")
    def stormctrl_bcast_rate(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def stormctrl_bcast_rate(self, value: pulumi.Input[Optional[_builtins.float]]):
    ...
    def stormctrl_mcast_level(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def stormctrl_mcast_level(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "stormctrl_mcast_level", value)

    @_builtins.property
    @pulumi.getter(name="stormctrlMcastRate")
    def stormctrl_mcast_rate(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def stormctrl_mcast_rate(self, value: pulumi.Input[Optional[_builtins.float]]):
    ...
    def stormctrl_ucast_level(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def stormctrl_ucast_level(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "stormctrl_ucast_level", value)

    @_builtins.property
    @pulumi.getter(name="stormctrlUcastRate")
    def stormctrl_ucast_rate(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def stormctrl_ucast_rate(self, value: pulumi.Input[Optional[_builtins.float]]):
...
@pulumi.type_token("unifi:index/portProfile:PortProfile")
class PortProfile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PortProfile, __self__).__init__(
            'unifi:index/portProfile:PortProfile',
            resource_name,
            __props__,
            opts,
    ...
    def get(resource_name: str,
            ...
            stp_port_mode: pulumi.Input[Optional[_builtins.bool]] = None,
            tagged_vlan_mgmt: pulumi.Input[Optional[_builtins.str]] = None,
            voice_networkconf_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'PortProfile':
        """
        ...
        __props__ = _PortProfileState.__new__(_PortProfileState)
    ...
    @_builtins.property
    @pulumi.getter(name="dot1xIdleTimeout")
    def dot1x_idle_timeout(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The number of seconds before an inactive authenticated MAC address is removed when using MAC-based 802.1X control. Range: 0-65535 seconds. Defaults to <span pulumi-lang-nodejs="`300`" pulumi-lang-dotnet="`300`" pulumi-lang-go="`300`" pulumi-lang-python="`300`" pulumi-lang-yaml="`300`" pulumi-lang-java="`300`" pulumi-lang-hcl="`300`">`300`</span>.
        """
        return pulumi.get(self, "dot1x_idle_timeout")
    ...
    @_builtins.property
    @pulumi.getter(name="egressRateLimitKbps")
    def egress_rate_limit_kbps(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The maximum outbound bandwidth allowed on the port in kilobits per second. Range: 64-9999999 kbps. Only applied when<span pulumi-lang-nodejs=" egressRateLimitKbpsEnabled " pulumi-lang-dotnet=" EgressRateLimitKbpsEnabled " pulumi-lang-go=" egressRateLimitKbpsEnabled " pulumi-lang-python=" egress_rate_limit_kbps_enabled " pulumi-lang-yaml=" egressRateLimitKbpsEnabled " pulumi-lang-java=" egressRateLimitKbpsEnabled " pulumi-lang-hcl=" egress_rate_limit_kbps_enabled "> egressRateLimitKbpsEnabled </span>is true.
        """
        return pulumi.get(self, "egress_rate_limit_kbps")
    ...
    @_builtins.property
    @pulumi.getter(name="priorityQueue1Level")
    def priority_queue1_level(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Priority queue 1 level (0-100) for Quality of Service (QoS). Used for:
        * Low-priority background traffic
        * Bulk data transfers
    ...
    @_builtins.property
    @pulumi.getter(name="priorityQueue2Level")
    def priority_queue2_level(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Priority queue 2 level (0-100) for Quality of Service (QoS). Used for:
        * Standard user traffic
        * Web browsing and email
    ...
    @_builtins.property
    @pulumi.getter(name="priorityQueue3Level")
    def priority_queue3_level(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Priority queue 3 level (0-100) for Quality of Service (QoS). Used for:
        * High-priority traffic
        * Voice and video conferencing
    ...
    @_builtins.property
    @pulumi.getter(name="priorityQueue4Level")
    def priority_queue4_level(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Priority queue 4 level (0-100) for Quality of Service (QoS). Used for:
        * Highest priority traffic
        * Critical real-time applications
    ...
    @_builtins.property
    @pulumi.getter(name="stormctrlBcastLevel")
    def stormctrl_bcast_level(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The broadcast Storm Control level for the port profile. Can be between 0 and 100.
        """
        return pulumi.get(self, "stormctrl_bcast_level")
    ...
    @_builtins.property
    @pulumi.getter(name="stormctrlBcastRate")
    def stormctrl_bcast_rate(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Maximum broadcast traffic rate in packets per second (0 - 14880000). Used to:
        * Control broadcast traffic levels
        * Prevent network congestion
    ...
    @_builtins.property
    @pulumi.getter(name="stormctrlMcastLevel")
    def stormctrl_mcast_level(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The multicast Storm Control level for the port profile. Can be between 0 and 100.
        """
        return pulumi.get(self, "stormctrl_mcast_level")
    ...
    @_builtins.property
    @pulumi.getter(name="stormctrlMcastRate")
    def stormctrl_mcast_rate(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Maximum multicast traffic rate in packets per second (0 - 14880000). Used to:
        * Control multicast traffic levels
        * Ensure bandwidth for critical multicast services
    ...
    @_builtins.property
    @pulumi.getter(name="stormctrlUcastLevel")
    def stormctrl_ucast_level(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The unknown unicast Storm Control level for the port profile. Can be between 0 and 100.
        """
        return pulumi.get(self, "stormctrl_ucast_level")
    ...
    @_builtins.property
    @pulumi.getter(name="stormctrlUcastRate")
    def stormctrl_ucast_rate(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        Maximum unknown unicast traffic rate in packets per second (0 - 14880000). Used to:
        * Control unknown unicast traffic levels
        * Prevent network saturation from unknown destinations
