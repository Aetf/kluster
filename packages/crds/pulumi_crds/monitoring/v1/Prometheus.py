...
__all__ = ['PrometheusInitArgs', 'Prometheus']

@pulumi.input_type
class PrometheusInitArgs:
    def __init__(__self__, *,
                 api_version: Optional[pulumi.Input[_builtins.str]] = None,
                 kind: Optional[pulumi.Input[_builtins.str]] = None,
                 metadata: Optional[pulumi.Input['_meta.v1.ObjectMetaArgs']] = None,
                 spec: Optional[pulumi.Input['PrometheusSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input['PrometheusSpecArgs']]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: Optional[pulumi.Input['PrometheusSpecArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:monitoring.coreos.com/v1:Prometheus")
class Prometheus(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[Union['PrometheusSpecArgs', 'PrometheusSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PrometheusInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The `Prometheus` custom resource definition (CRD) defines a desired [Prometheus](https://prometheus.io/docs/prometheus) setup to run in a Kubernetes cluster. It allows to specify many options such as the number of replicas, persistent storage, and Alertmanagers where firing alerts should be sent and many more.
        ...
        :param str resource_name: The name of the resource.
        :param PrometheusInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PrometheusInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PrometheusInitArgs.__new__(PrometheusInitArgs)
