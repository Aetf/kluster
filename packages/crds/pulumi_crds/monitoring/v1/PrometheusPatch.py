...
__all__ = ['PrometheusPatchArgs', 'PrometheusPatch']

@pulumi.input_type
class PrometheusPatchArgs:
    def __init__(__self__, *,
                 api_version: Optional[pulumi.Input[_builtins.str]] = None,
                 kind: Optional[pulumi.Input[_builtins.str]] = None,
                 metadata: Optional[pulumi.Input['_meta.v1.ObjectMetaPatchArgs']] = None,
                 spec: Optional[pulumi.Input['PrometheusSpecPatchArgs']] = None):
        """
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'Prometheus')
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input['PrometheusSpecPatchArgs']]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: Optional[pulumi.Input['PrometheusSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:monitoring.coreos.com/v1:PrometheusPatch")
class PrometheusPatch(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 spec: Optional[pulumi.Input[Union['PrometheusSpecPatchArgs', 'PrometheusSpecPatchArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PrometheusPatchArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        Server-Side Apply updates. The name of the resource must be specified, but all other properties are optional. More than
        ...
        :param str resource_name: The name of the resource.
        :param PrometheusPatchArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PrometheusPatchArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PrometheusPatchArgs.__new__(PrometheusPatchArgs)

            __props__.__dict__["api_version"] = 'monitoring.coreos.com/v1'
            __props__.__dict__["kind"] = 'Prometheus'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["spec"] = spec
            __props__.__dict__["status"] = None
        super(PrometheusPatch, __self__).__init__(
            'kubernetes:monitoring.coreos.com/v1:PrometheusPatch',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'PrometheusPatch':
        """
        ...
        __props__.__dict__["status"] = None
        return PrometheusPatch(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.PrometheusSpecPatch']]:
        return pulumi.get(self, "spec")

    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.PrometheusStatusPatch']]:
