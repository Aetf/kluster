...
__all__ = ['MiddlewareInitArgs', 'Middleware']

@pulumi.input_type
class MiddlewareInitArgs:
...
@pulumi.type_token("kubernetes:traefik.io/v1alpha1:Middleware")
class Middleware(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[Union['MiddlewareSpecArgs', 'MiddlewareSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MiddlewareInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Middleware is the CRD implementation of a Traefik Middleware.
        More info: https://doc.traefik.io/traefik/v3.2/middlewares/http/overview/
        ...
        :param str resource_name: The name of the resource.
        :param MiddlewareInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MiddlewareInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MiddlewareInitArgs.__new__(MiddlewareInitArgs)
        ...
        super(Middleware, __self__).__init__(
            'kubernetes:traefik.io/v1alpha1:Middleware',
            resource_name,
            __props__,
            opts)
