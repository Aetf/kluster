...
class SealedSecretSpecTemplatePatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] immutable: Immutable, if set to true, ensures that data stored in the Secret cannot
               be updated (only object metadata can be modified).
               If not set to true, the field can be modified at any time.
               Defaulted to nil.
...
class SealedSecretStatusConditionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] status: Status of the condition for a sealed secret.
               Valid values for "Synced": "True", "False", or "Unknown".
        :param pulumi.Input[str] type: Type of condition for a sealed secret.
               Valid value: "Synced"
        """
