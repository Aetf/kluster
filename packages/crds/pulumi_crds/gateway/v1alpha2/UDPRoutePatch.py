...
__all__ = ['UDPRoutePatchArgs', 'UDPRoutePatch']

@pulumi.input_type
class UDPRoutePatchArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[_builtins.str]] = None,
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaPatchArgs']] = None,
                 spec: pulumi.Input[Optional['UDPRouteSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['UDPRouteSpecPatchArgs']]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: pulumi.Input[Optional['UDPRouteSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1alpha2:UDPRoutePatch")
class UDPRoutePatch(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 spec: pulumi.Input[Optional[Union['UDPRouteSpecPatchArgs', 'UDPRouteSpecPatchArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[UDPRoutePatchArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        Server-Side Apply updates. The name of the resource must be specified, but all other properties are optional. More than
        ...
        :param str resource_name: The name of the resource.
        :param UDPRoutePatchArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(UDPRoutePatchArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = UDPRoutePatchArgs.__new__(UDPRoutePatchArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1:UDPRoutePatch")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UDPRoutePatch, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1alpha2:UDPRoutePatch',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'UDPRoutePatch':
        """
        ...
        __props__.__dict__["status"] = None
        return UDPRoutePatch(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.UDPRouteSpecPatch']]:
        return pulumi.get(self, "spec")

    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.UDPRouteStatusPatch']]:
