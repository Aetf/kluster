...
__all__ = ['ListenerSetPatchArgs', 'ListenerSetPatch']

@pulumi.input_type
class ListenerSetPatchArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[_builtins.str]] = None,
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaPatchArgs']] = None,
                 spec: pulumi.Input[Optional['ListenerSetSpecPatchArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ListenerSetSpecPatchArgs']]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ListenerSetSpecPatchArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1:ListenerSetPatch")
class ListenerSetPatch(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 spec: pulumi.Input[Optional[Union['ListenerSetSpecPatchArgs', 'ListenerSetSpecPatchArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ListenerSetPatchArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        Server-Side Apply updates. The name of the resource must be specified, but all other properties are optional. More than
        ...
        :param str resource_name: The name of the resource.
        :param ListenerSetPatchArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ListenerSetPatchArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ListenerSetPatchArgs.__new__(ListenerSetPatchArgs)
        ...
        super(ListenerSetPatch, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1:ListenerSetPatch',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ListenerSetPatch':
        """
        ...
        __props__.__dict__["status"] = None
        return ListenerSetPatch(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.ListenerSetSpecPatch']]:
        return pulumi.get(self, "spec")

    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.ListenerSetStatusPatch']]:
