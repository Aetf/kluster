...
__all__ = ['TCPRouteInitArgs', 'TCPRoute']

@pulumi.input_type
class TCPRouteInitArgs:
...
@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1:TCPRoute")
class TCPRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['TCPRouteSpecArgs', 'TCPRouteSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[TCPRouteInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        TCPRoute provides a way to route TCP requests. When combined with a Gateway
        listener, it can be used to forward connections on the port specified by the
        ...
        :param str resource_name: The name of the resource.
        :param TCPRouteInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TCPRouteInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TCPRouteInitArgs.__new__(TCPRouteInitArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1alpha2:TCPRoute")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TCPRoute, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1:TCPRoute',
            resource_name,
            __props__,
            opts)
