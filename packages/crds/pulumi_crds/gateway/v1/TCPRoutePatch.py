...
__all__ = ['TCPRoutePatchArgs', 'TCPRoutePatch']
...
@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1:TCPRoutePatch")
class TCPRoutePatch(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[TCPRoutePatchArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        Server-Side Apply updates. The name of the resource must be specified, but all other properties are optional. More than
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TCPRoutePatchArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TCPRoutePatchArgs.__new__(TCPRoutePatchArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1alpha2:TCPRoutePatch")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TCPRoutePatch, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1:TCPRoutePatch',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TCPRoutePatch':
        """
        ...
        __props__.__dict__["status"] = None
        return TCPRoutePatch(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.TCPRouteSpecPatch']]:
        return pulumi.get(self, "spec")

    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.TCPRouteStatusPatch']]:
