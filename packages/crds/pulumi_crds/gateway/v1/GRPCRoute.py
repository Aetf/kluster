...
__all__ = ['GRPCRouteInitArgs', 'GRPCRoute']

@pulumi.input_type
class GRPCRouteInitArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[_builtins.str]] = None,
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 spec: pulumi.Input[Optional['GRPCRouteSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['GRPCRouteSpecArgs']]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: pulumi.Input[Optional['GRPCRouteSpecArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1:GRPCRoute")
class GRPCRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['GRPCRouteSpecArgs', 'GRPCRouteSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[GRPCRouteInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        GRPCRoute provides a way to route gRPC requests. This includes the capability
        to match requests by hostname, gRPC service, gRPC method, or HTTP/2 header.
        ...
        :param str resource_name: The name of the resource.
        :param GRPCRouteInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GRPCRouteInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GRPCRouteInitArgs.__new__(GRPCRouteInitArgs)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.GRPCRouteSpec']:
        return pulumi.get(self, "spec")
