...
@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1:TLSRoute")
class TLSRoute(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1alpha2:TLSRoute"), pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRoute")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TLSRoute, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1:TLSRoute',
            resource_name,
            __props__,
            opts)
