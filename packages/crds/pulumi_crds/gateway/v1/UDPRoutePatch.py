...
@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1:UDPRoutePatch")
class UDPRoutePatch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1alpha2:UDPRoutePatch")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UDPRoutePatch, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1:UDPRoutePatch',
            resource_name,
            __props__,
            opts)
