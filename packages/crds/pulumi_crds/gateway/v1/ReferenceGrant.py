...
__all__ = ['ReferenceGrantInitArgs', 'ReferenceGrant']

@pulumi.input_type
class ReferenceGrantInitArgs:
    def __init__(__self__, *,
                 api_version: pulumi.Input[Optional[_builtins.str]] = None,
                 kind: pulumi.Input[Optional[_builtins.str]] = None,
                 metadata: pulumi.Input[Optional['_meta.v1.ObjectMetaArgs']] = None,
                 spec: pulumi.Input[Optional['ReferenceGrantSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ReferenceGrantSpecArgs']]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ReferenceGrantSpecArgs']]):
        pulumi.set(self, "spec", value)


@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1:ReferenceGrant")
class ReferenceGrant(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['ReferenceGrantSpecArgs', 'ReferenceGrantSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ReferenceGrantInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ReferenceGrant identifies kinds of resources in other namespaces that are
        trusted to reference the specified kinds of resources in the same namespace
        ...
        :param str resource_name: The name of the resource.
        :param ReferenceGrantInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ReferenceGrantInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ReferenceGrantInitArgs.__new__(ReferenceGrantInitArgs)

            __props__.__dict__["api_version"] = 'gateway.networking.k8s.io/v1'
            __props__.__dict__["kind"] = 'ReferenceGrant'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["spec"] = spec
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1beta1:ReferenceGrant")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReferenceGrant, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1:ReferenceGrant',
            resource_name,
            __props__,
            opts)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.ReferenceGrantSpec']:
        return pulumi.get(self, "spec")
