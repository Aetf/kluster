...
@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayClass")
class GatewayClass(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1:GatewayClass")])
