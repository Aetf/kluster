...
__all__ = ['XListenerSetInitArgs', 'XListenerSet']

@pulumi.input_type
class XListenerSetInitArgs:
...
@pulumi.type_token("kubernetes:gateway.networking.x-k8s.io/v1alpha1:XListenerSet")
class XListenerSet(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 spec: Optional[pulumi.Input[Union['XListenerSetSpecArgs', 'XListenerSetSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[XListenerSetInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        XListenerSet defines a set of additional listeners to attach to an existing Gateway.
        This resource provides a mechanism to merge multiple listeners into a single Gateway.
        ...
        :param str resource_name: The name of the resource.
        :param XListenerSetInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(XListenerSetInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = XListenerSetInitArgs.__new__(XListenerSetInitArgs)
        ...
        super(XListenerSet, __self__).__init__(
            'kubernetes:gateway.networking.x-k8s.io/v1alpha1:XListenerSet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'XListenerSet':
        """
        ...
        __props__.__dict__["status"] = None
        return XListenerSet(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.XListenerSetSpec']:
        return pulumi.get(self, "spec")

    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.XListenerSetStatus']]:
