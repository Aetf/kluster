...
__all__ = ['TLSRouteInitArgs', 'TLSRoute']

@pulumi.input_type
class TLSRouteInitArgs:
...
@pulumi.type_token("kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRoute")
class TLSRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: pulumi.Input[Optional[Union['TLSRouteSpecArgs', 'TLSRouteSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[TLSRouteInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The TLSRoute resource is similar to TCPRoute, but can be configured
        to match against TLS-specific metadata. This allows more flexibility
        ...
        :param str resource_name: The name of the resource.
        :param TLSRouteInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TLSRouteInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TLSRouteInitArgs.__new__(TLSRouteInitArgs)
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1:TLSRoute"), pulumi.Alias(type_="kubernetes:gateway.networking.k8s.io/v1alpha2:TLSRoute")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TLSRoute, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRoute',
            resource_name,
            __props__,
            opts)
