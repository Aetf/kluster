...
@pulumi.type_token("kubernetes:postgresql.cnpg.io/v1:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[Union['ClusterSpecArgs', 'ClusterSpecArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ClusterInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Cluster defines the API schema for a highly available PostgreSQL database cluster
        managed by CloudNativePG.
