...
__all__ = ['PortalFileArgs', 'PortalFile']

@pulumi.input_type
class PortalFileArgs:
...
class _PortalFileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] file_path: Path to the file on the local filesystem to upload to the UniFi controller. The file must exist and be readable.
        :param pulumi.Input[_builtins.float] file_size: Size of the file in bytes.
        :param pulumi.Input[_builtins.str] filename: Name of the file as stored in the UniFi controller.
        :param pulumi.Input[_builtins.float] last_modified: Timestamp when the file was last modified.
...
@pulumi.type_token("unifi:index/portalFile:PortalFile")
class PortalFile(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a PortalFile resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PortalFileArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PortalFileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PortalFileArgs.__new__(PortalFileArgs)
        ...
        super(PortalFile, __self__).__init__(
            'unifi:index/portalFile:PortalFile',
            resource_name,
            __props__,
            opts,
    ...
    def get(resource_name: str,
            ...
            md5: pulumi.Input[Optional[_builtins.str]] = None,
            site: pulumi.Input[Optional[_builtins.str]] = None,
            url: pulumi.Input[Optional[_builtins.str]] = None) -> 'PortalFile':
        """
        ...
        __props__ = _PortalFileState.__new__(_PortalFileState)
        ...
        return PortalFile(resource_name, opts=opts, __props__=__props__)
