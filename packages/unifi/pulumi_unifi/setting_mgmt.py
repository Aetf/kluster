...
class SettingMgmtArgs:
    def __init__(__self__, *,
                 ...
                 auto_upgrade_hour: pulumi.Input[Optional[_builtins.float]] = None,
                 ...
                 ssh_keys: pulumi.Input[Optional[Sequence[pulumi.Input['SettingMgmtSshKeyArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.float] auto_upgrade_hour: The hour of the day (0-23) when automatic firmware upgrades will occur.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SettingMgmtSshKeyArgs']]] ssh_keys: List of SSH public keys that are allowed to connect to UniFi devices when SSH is enabled. Using SSH keys is more secure than password authentication.
    ...
    def auto_upgrade_hour(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def auto_upgrade_hour(self, value: pulumi.Input[Optional[_builtins.float]]):
    ...
    def ssh_keys(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SettingMgmtSshKeyArgs']]]]:
        """
    ...
    @ssh_keys.setter
    def ssh_keys(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SettingMgmtSshKeyArgs']]]]):
...
@pulumi.type_token("unifi:index/settingMgmt:SettingMgmt")
class SettingMgmt(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssh_username: pulumi.Input[Optional[_builtins.str]] = None,
            unifi_idp_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            wifiman_enabled: pulumi.Input[Optional[_builtins.bool]] = None) -> 'SettingMgmt':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="autoUpgradeHour")
    def auto_upgrade_hour(self) -> pulumi.Output[_builtins.float]:
        """
        The hour of the day (0-23) when automatic firmware upgrades will occur.
        """
        return pulumi.get(self, "auto_upgrade_hour")
